...
window.APP_CONFIG = {
  ...
  notice: {
    title: "树洞精灵上线啦 ✨",
    text: "树洞已接入 AI，姐姐快去和树洞精灵聊一聊吧~ 桌宠正在研发中，稍微等一下下下下下~ 🐣",
    date: "2026-08-01"
  },
  ...
  lawDb: [
    ...
    // ===== 应届生 / 职场新人 专属（求职 · 实习 · 试用期 · 租房） =====
    { from:"《普通高校就业规定》", title:"三方协议≠劳动合同", content:"三方协议是毕业生、学校、单位三方约定，不等于劳动合同；入职后单位必须依法再签书面劳动合同。", tip:"签了三方也要签劳动合同；违约赔多少看三方约定，看清违约金条款再签。" },
    { from:"实习协议", title:"在校实习看协议", content:"在校实习一般不构成劳动关系，应签实习协议，明确报酬、工时与意外伤害保障；毕业转正必须签劳动合同。", tip:"凡让实习生‘先交钱/押证件’的，基本是骗局，立即拒绝并举报。" },
    { from:"《劳动合同法》第19条", title:"试用期时长上限", content:"合同期 3 个月以上不满 1 年，试用期≤1 个月；1 年以上不满 3 年，≤2 个月；3 年以上固定期限，≤6 个月；不得只约定试用期。", tip:"超过法定上限的试用期无效，且‘试岗’不签合同也违法，可主张双倍工资。" },
    { from:"《劳动合同法》第20条", title:"试用期工资", content:"劳动者在试用期的工资不得低于本单位同岗位最低档工资或劳动合同约定工资的 80%，并不得低于用人单位所在地最低工资标准。", tip:"试用期也被压到低于 80% 或当地最低工资的，可投诉要求补足。" },
    { from:"《劳动合同法》第25条", title:"违约金有限情形", content:"只有在‘单位提供专项培训并约定服务期’和‘竞业限制’两种情形下，才能约定由劳动者承担违约金；其他‘不干就赔钱’的条款通常无效。", tip:"签合同时看到一大堆违约金条款，多半不合法，别被吓住。" },
    { from:"《劳动合同法》第22条", title:"培训服务期", content:"单位为你出钱做专项技术培训，可约定服务期；违约按未履行比例赔偿，且赔偿总额不超过实际培训费用。", tip:"普通入职培训、岗前培训不算‘专项培训’，不能据此设服务期。" },
    { from:"《劳动合同法》第37条", title:"辞职通知期", content:"正式员工提前 30 日书面通知用人单位可解除劳动合同；试用期内提前 3 日通知即可，无需单位批准。", tip:"以‘个人原因’离职一般无经济补偿；单位欠薪/不缴社保可随时走并索赔。" },
    { from:"《劳动合同法》第50条", title:"离职证明与档案", content:"单位解除或终止劳动合同，应出具离职证明，并在 15 日内办理档案和社保转移；不得扣押证件、不得拒开证明。", tip:"下家入职常要离职证明，原单位拖着不给可投诉劳动监察。" },
    { from:"《职工带薪年休假条例》", title:"带薪年假", content:"连续工作已满 1 年不满 10 年享 5 天年假；10–20 年 10 天；20 年以上 15 天。单位不安排应支付 3 倍工资。", tip:"新人参职当年按剩余日历天数折算年假，别被‘第一年没假’忽悠。" },
    { from:"《工伤保险条例》", title:"工伤认定", content:"在工作时间、工作场所内受伤，以及上下班途中受非本人主要责任的交通事故等，都可能认定为工伤；单位应在 30 日内申报。", tip:"通勤摔伤、加班猝死都可能是工伤；留好证据，单位不报可自行申请。" },
    { from:"《劳动合同法》第85条", title:"拖欠工资", content:"用人单位未按约定或规定支付劳动报酬的，劳动行政部门可责令限期支付，逾期加付应付金额 50%–100% 赔偿。", tip:"工资拖欠先留考勤、工资条证据，再投诉或仲裁，别忍气吞声。" },
    { from:"《住房租赁条例》", title:"租房押金", content:"住房租赁押金一般不得超过一个月租金；不得变相收取看房费、信息费；退租应按约退还押金。", tip:"押一付三常见，但‘押二付一’‘服务费不退’多有不合规，签合同前谈清。" },
    { from:"《民法典》第716条", title:"转租需同意", content:"承租人经出租人同意可将租赁物转租；未经同意转租，出租人可解除合同。", tip:"二房东转租务必看原合同是否允许，避免被真房东清退钱房两空。" },
    { from:"招聘反诈提示", title:"求职防骗", content:"凡要求‘先交钱、办卡、培训贷、押证件’的招聘，极可能是诈骗；录取以单位官方通知为准。", tip:"刷单、冒充 HR、‘内推费’都是高频骗局；不转账、不贪小利是底线。" },
    { from:"《个人所得税法》", title:"个税起征点", content:"综合所得基本减除费用 60000 元/年（即 5000 元/月）；子女教育、继续教育、租房、房贷、赡养老人等专项附加扣除可减税。", tip:"应届生租房、考证都能填报专项附加扣除，到手工资会变多。" },
    { from:"社保缴纳提示", title:"试用期也缴社保", content:"劳动关系存续期间（含试用期）单位应依法为职工缴纳社保；‘试用期不缴’违法，影响医保、工伤待遇。", tip:"入职当月或次月应参保，断缴会影响落户、买房、医保报销。" },
    { from:"《妇女权益保障法》第27条", title:"婚育不受歧视", content:"用人单位不得因结婚、怀孕、产假、哺乳等情形，降低女职工工资、予以辞退或限制晋升。", tip:"产检时间计入劳动时间；孕期被降薪/辞退可仲裁并索赔。" },
    { from:"《劳动合同法》第17条", title:"合同必备条款", content:"劳动合同应写明合同期限、工作内容与地点、报酬、社保、劳动保护等；空白合同不要签。", tip:"签字前逐项核对，报酬、岗位写清楚，口头承诺要落进合同才作数。" }
  ],
